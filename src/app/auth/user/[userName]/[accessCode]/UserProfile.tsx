...
export function Header({ userName, accessCode }: { userName: string, accessCode: string }) {
    const pathname = usePathname()
    const menu: MenuItem[] = [
        {
            menuName: "Home",
            path: `/auth/user/${userName}/${accessCode}`,
            icon: "hgi hgi-stroke hgi-home-01"
        },
        {
            menuName: "About",
            path: `/auth/user/${userName}/${accessCode}/about`,
            icon: "hgi hgi-stroke hgi-user-account"
        },
        {
            menuName: "Work/Education",
            path: `/auth/user/${userName}/${accessCode}/work`,
            icon: "hgi hgi-stroke hgi-briefcase-01"
        },
        {
            menuName: "Skills/Tools",
            path: `/auth/user/${userName}/${accessCode}/expert-area`,
            icon: "hgi hgi-stroke hgi-ai-idea"
        },
        {
            menuName: "Contact",
            path: `/auth/user/${userName}/${accessCode}/contact`,
    ...
    const isActiveLink = (menuPath: string): boolean => {
        if (menuPath === `/auth/user/${userName}/${accessCode}`) {
            ...
            <nav className='navbar'>
                <div className="menu-container">
                    <div className="logo-container">
                        <Link href={`/auth/user/${userName}/${accessCode}`}>
...
function Hero({ userData, loading }: HeroProps) {
    const { user, accessCode } = useUserContext();
                    ...
                    loading ? (
                        ...
                        <motion.div
                            ...
                            <div className="title">
                                ...
                                <Link href={`/auth/user/${user}/${accessCode}/work`}>
                                    All Project
